...
export const deDE: Dictionary = {
  ...
  viewerNext: {
    ...
    cards: {
      ...
      gutters: "Rinnen & Fallrohre",
      height: "Höhe",
      walls: "Fassaden",
      openings: "Öffnungen",
      trim: "Verkleidung & Dachrand",
      conditionAreas: "Schadstellen",
    },
    filters: {
      all: "Alle",
      roofing: "Dach",
    ...
    labels: {
      ...
      rakes: "Ortgänge",
      total: "gesamt",
      gutterRun: "LF Rinnenlauf",
      stories: "Geschosse",
      corners: "Ecken",
      areas: "Flächen",
      suggestedWaste: "Empfohlener Verschnitt",
      dripEdge: "Tropfkante",
      fromEavesRakes: "aus Traufen + Ortgängen",
      ridge: "First",
      hip: "Grat",
      valley: "Kehle",
      flashing: "Anschlussblech",
      ...
      drops: "Fallrohre",
      drop: "Fallrohr",
      eaveHeight: "Traufhöhe",
      ridgeHeight: "Firsthöhe",
      parapetHeight: "Attikahöhe",
      ofWhichGables: "davon Giebel {area} sq ft",
      gross: "brutto",
      gable: "Giebel",
      openings: "Öffnungen",
      perimeter: "Umfang",
      fascia: "Stirnbrett",
      soffit: "Untersicht",
      outsideCorners: "Außenecken",
      insideCorners: "Innenecken",
    ...
    transferredVia: "Übertragen über",
